...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initSwiper.initCoachesSlider)();
    (0, _initSwiper.initReviewsSlider)();
  ...
  function setMenuHeight() {
    ...
    var deltaHeight = document.body.offsetHeight - header.offsetHeight;
...
},{"./modules/form-validate/form":3,"./modules/swiper/init-swiper":9,"./utils/ios-vh-fix":11}],2:[function(require,module,exports){
"use strict";
...
exports.initReviewsSlider = exports.initCoachesSlider = void 0;
var _window = window,
